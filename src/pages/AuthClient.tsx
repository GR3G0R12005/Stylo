...
import { LogIn, UserPlus, ArrowLeft, Mail, Lock, User, Phone, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10">
          ...
          <form onSubmit={isLogin ? handleLogin : handleRegister} className="space-y-4">
            ...
            <button
              disabled={loading}
              type="submit"
              className="w-full bg-blue-500 text-white font-bold py-4 rounded-2xl hover:bg-blue-600 transition-colors flex items-center justify-center gap-2 mt-4 disabled:opacity-50"
            >
